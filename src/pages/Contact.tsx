    ...
    <div className="bg-background transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 py-12 grid md:grid-cols-2 gap-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="bg-accent text-accent-foreground rounded-lg h-12 px-8 font-bold hover:scale-105 transition-all duration-200">{t('sendMessage')}</Button>
        </form>

        <div className="space-y-6">
          <div className="bg-card rounded-xl p-6 border border-border space-y-4 transition-colors duration-300">
            <div className="flex items-start gap-3"><MapPin className="w-5 h-5 text-accent shrink-0 mt-0.5" /><div><div className="font-semibold text-foreground">Address</div><div className="text-sm text-muted-foreground">Kathmandu, Nepal</div></div></div>
            <div className="flex items-start gap-3"><Phone className="w-5 h-5 text-accent shrink-0 mt-0.5" /><div><div className="font-semibold text-foreground">Phone</div><div className="text-sm text-muted-foreground">+977 XXXXXXXXXX</div></div></div>
            <div className="flex items-start gap-3"><Mail className="w-5 h-5 text-accent shrink-0 mt-0.5" /><div><div className="font-semibold text-foreground">Email</div><div className="text-sm text-muted-foreground">info@tpcpower.com</div></div></div>
          </div>
          ...
          {/* Mobile direct call */}
          <a href="tel:+977XXXXXXXXXX" className="block md:hidden">
